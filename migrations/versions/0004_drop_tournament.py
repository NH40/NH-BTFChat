"""drop power battle tournament module

Revision ID: 0004_drop_tournament
Revises: 0003_tournament
Create Date: 2026-09-07

The Power Battle tournament feature was removed from the bot. This migration
drops every table it introduced in 0003. Downgrade re-creates them empty.
"""
from alembic import op
import sqlalchemy as sa

revision = "0004_drop_tournament"
down_revision = "0003_tournament"
branch_labels = None
depends_on = None
